...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20251226140109_AddMaintenanceMode'
)
BEGIN
    CREATE TABLE [MaintenanceModes] (
        ...
        CONSTRAINT [PK_MaintenanceModes] PRIMARY KEY ([Id])
    );
END;
GO
...
BEGIN
    CREATE TABLE [HealthCheckResults] (
        ...
        CONSTRAINT [FK_HealthCheckResults_Services_ServiceId] FOREIGN KEY ([ServiceId]) REFERENCES [Services] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE TABLE [ServiceConfigurations] (
        ...
        CONSTRAINT [PK_ServiceConfigurations] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_ServiceConfigurations_Services_ServiceId] FOREIGN KEY ([ServiceId]) REFERENCES [Services] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE TABLE [Webhooks] (
        ...
        CONSTRAINT [FK_Webhooks_Services_ServiceId] FOREIGN KEY ([ServiceId]) REFERENCES [Services] ([Id]) ON DELETE SET NULL
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_HealthCheckResults_CheckedAt] ON [HealthCheckResults] ([CheckedAt]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_HealthCheckResults_ServiceId] ON [HealthCheckResults] ([ServiceId]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_HealthCheckResults_ServiceId_CheckedAt] ON [HealthCheckResults] ([ServiceId], [CheckedAt]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_HealthCheckResults_Status] ON [HealthCheckResults] ([Status]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_MaintenanceModes_CreatedAt] ON [MaintenanceModes] ([CreatedAt]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_MaintenanceModes_IsEnabled] ON [MaintenanceModes] ([IsEnabled]);
END;
GO
...
BEGIN
    CREATE UNIQUE INDEX [IX_ServiceConfigurations_ServiceId] ON [ServiceConfigurations] ([ServiceId]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Services_IsEnabled] ON [Services] ([IsEnabled]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Services_IsPublic] ON [Services] ([IsPublic]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Webhooks_IsEnabled] ON [Webhooks] ([IsEnabled]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Webhooks_ServiceId] ON [Webhooks] ([ServiceId]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20251226140109_AddMaintenanceMode', N'8.0.22');
END;
GO
